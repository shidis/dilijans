<!-- Отправляется клиенту при оформлении заказа. Тип плательщика: юрик -->
<?
$ss=new Content();
?>
<html>
...
<a href="https://samohodoff.ru"><img height="40" alt="Дилижанс" src="https://<?=Cfg::get('site_url').'/app/templates/images/logo.png'?>" title="Дилижанс" style="float: right;"></a>
