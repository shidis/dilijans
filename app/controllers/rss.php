<?
class App_Rss_Controller extends App_Common_Controller {
    public function index() {
        ...
        //
        if (is_file($app->namespace . '/view/rss.php')) {
            extract((array)$app->controllerInstance, EXTR_OVERWRITE);
            extract($app->controllerInstance->_data, EXTR_OVERWRITE);
            include $app->namespace . '/view/rss.php';
        } else
            throw new AppException ('[App::output()]: ' . $app->namespace . '/view/rss.php open fault.');
        unset($cc);
        exit(200);
    }
}