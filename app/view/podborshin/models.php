    ...
    <div class="box-padding">
        ...
        <div class="title_text ctext">
            ...
            if (!empty($upText)) {
                ...
                ?>
                <p>
                    Для того чтобы подобрать шины для вашего <?= $mark ?>, воспользуйтесь формой ниже и выберите интересующую модель <?= $mark_alt ?>. Затем выберите год выпуска вашего авто и модификацию двигателя.
                </p>
            <? } ?>
        </div>
        ...
        <? if (!empty($replicaCross)) { ?>
            ...
            <!-- <p style="margin-top: 15px"><a href="<?= $replicaCross['url'] ?>" title="<?= $replicaCross['title'] ?>"><?= $replicaCross['anc'] ?></a> </p>-->
