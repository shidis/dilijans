...
/* V2   Здесь реализована функция слияния моделей*/
...
CatImport = {init: function() { return new function() {
	...
	function resizeView(){
		$('.import #viewGrid').setGridWidth($('#uil-center').innerWidth()-50);
		$('.import #viewGrid').setGridHeight($('#uil-center').innerHeight()-160);
	}
	var layoutSettings={
...
//				autowidth: true,
				...
				sortname: 'item_id',
				sortorder: 'asc',
				width:$('#uil-center').innerWidth()-50,
				height: $('#uil-center').innerHeight()-160,
				rowNum: 70,
