...
$tinybrowser['sessioncheck'] = 'CANED'; //name of session variable to check


// Random string used to secure Flash upload if session control not enabled - be sure to change!
$tinybrowser['obfuscate'] = Cfg::get('TB_obfuscate');
...
$tinybrowser['path']['image'] = '/'.Cfg::get('cnt_upload_dir').'/image/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/'.Cfg::get('cnt_upload_dir').'/media/'; // Media files location
$tinybrowser['path']['file']  = '/'.Cfg::get('cnt_upload_dir').'/file/'; // Other files location
...
// Default file sort
$tinybrowser['order']['by']   = 'modified'; // Possible values: name, size, type, modified
$tinybrowser['order']['type'] = 'desc'; // Possible values: asc, desc
...
$tinybrowser['tinymcecss'] = '/cms/inc/tiny_mce/themes/advanced/skins/default/dialog.css';
